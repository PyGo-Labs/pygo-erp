...
func registerRoutes(app *web.App) {
	...
	for _, view := range []string{"/productos", "/clientes", "/facturas", "/login", "/companies", "/users", "/inventory", "/setup", "/ventas", "/compras", "/inventario", "/contabilidad", "/tesoreria", "/rrhh", "/produccion", "/admin"} {
		viewPath := view
